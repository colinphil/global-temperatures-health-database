...
def run():
    ...
    sql = 'SELECT * FROM kaggle2_modeled.Urban_Growth_Statistics limit 20'
    ...
    query_results | 'Write input' >> WriteToText('input_urban.txt')
    ...
    flatten_pcoll | 'Write output' >> WriteToText('output_urban_final.txt')
    
    #create new table in BigQuery
    dataset_id = 'kaggle2_modeled'
    table_id = 'Urban_Growth_Statistics_Beam'
