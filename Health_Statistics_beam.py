...
def run():
    ...
    sql = 'SELECT * FROM kaggle2_modeled.Health_Statistics limit 20'
    ...
    query_results | 'Write input' >> WriteToText('input_dates.txt')
    ...
    flatten_pcoll | 'Write output' >> WriteToText('output_final_dates.txt')
    
    #create new table in BigQuery
    dataset_id = 'kaggle2_modeled'
    table_id = 'Health_Statistics_Beam'
