...
def run():
    ...
    google_cloud_options.job_name = 'life-statistics-beam-dataflow-2'
    ...
    sql = 'SELECT * FROM kaggle2_modeled.Life_Statistics'
    ...
    query_results | 'Write input' >> WriteToText(DIR_PATH +'input_life.txt')
    ...
    flatten_pcoll | 'Write output' >> WriteToText(DIR_PATH + 'output_life_final.txt')
    
    #create new table in BigQuery
    dataset_id = 'kaggle2_modeled'
    table_id = 'Life_Statistics_Beam_DF'
